...
export default class MyRequests extends Component {
  constructor() {
    ...
    this.state = {
      loading: true,
      user_name: 'jyoti',
      tableHead: ['Request Date', 'Arrival Time', 'Exit Time', 'Valet'],
      widthArr: [120, 100, 80, 80]
    }
  ...
  render() {
    ...
    for (let i = 0; i < 20; i += 1) {
      const rowData = ['26th Aug, 2019 Thu', '08:30', '17:30', 'Jai'];
...
const styles = StyleSheet.create({
  container: { flex: 1, padding: 5, backgroundColor: '#fff',borderWidth: 2, margin: 5 },
